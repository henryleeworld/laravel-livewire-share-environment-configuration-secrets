                        ...
                        <div class="flex-shrink-0">
                            <div class="inline-flex relative rounded-md shadow-sm">
                                ...
                                <input wire:model.debounce.500ms="search" type="search"
                                       ...
                                       placeholder="{{ trans('frontend.apps.content.search') }}"
                                />
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="min-w-0 flex-1 flex items-center">
                                        <div>
                                            ...
                                            <div class="mt-2 flex items-center text-sm leading-5 text-gray-500">
                                                ...
                                                <span
                                                    class="truncate"
                                                >{{ count($app->variables) }} {{ count($app->variables) == 1 ? trans('frontend.apps.content.variable') : trans('frontend.apps.content.variables') }}</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div>
                            ...
                            <div class="min-w-0 flex-1 sm:flex sm:items-center sm:justify-between">
                                <div>
                                    <div class="leading-5 font-medium text-sm text-gray-800 truncate">
                                        {{ trans('frontend.apps.content.no_results_match') }}' }}
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="flex">
                            ...
                            <div class="ml-3">
                                <h3 class="text-sm leading-5 font-medium text-yellow-800">
                                    {{ trans('frontend.apps.content.no_apps') }}' }}
                                </h3>
                                <div class="mt-2 text-sm leading-5 text-yellow-700">
                                    <p>
                                        {{ trans('frontend.apps.content.there_are_currently_no_apps_here') }}' }}
                                    </p>
                                </div>
                            </div>
                        </div>
