    ...
    <form wire:submit.prevent="update" spellcheck="false">
            ...
            <div class="flex items-center justify-between flex-wrap sm:flex-no-wrap">
                <div>
                    <h3 class="text-lg leading-6 font-medium text-gray-900">
                        {{ trans('frontend.apps.edit.content.slack_notifications.title') }}
                    </h3>
                </div>
                <div>
        ...
        <div class="px-4 py-6 sm:px-6">
            <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start">
                ...
                >
                    <a href="https://slack.com/apps/A0F7XDUAZ-incoming-webhooks" target="blank">{{ trans('frontend.apps.edit.content.webhook_url') }}</a>
                </label>
            ...
            <div class="mt-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start">
                <label for="channel" class="block text-sm font-medium leading-5 text-gray-700 sm:mt-px sm:pt-2">
                    {{ trans('frontend.apps.edit.content.channel') }}
                </label>
                <div class="mt-1 sm:mt-0 sm:col-span-2">
                    <div class="relative rounded-md shadow-sm">
                        ...
                        <input wire:model.defer="slackNotificationChannel" id="channel" type="text" placeholder="{{ trans('frontend.apps.edit.content.general') }}"
        ...
        <div class="bg-gray-50 px-4 py-4 sm:px-6 flex">
            <div class="inline-flex flex-shrink-0 items-center">
                <p class="inline-flex text-sm leading-5 font-medium text-gray-700">
                    ...
                    {{ trans('frontend.apps.edit.content.slack_notifications.statement') }} {{ $this->app->slack_notification_channel && $this->app->slack_notification_webhook_url ? trans('frontend.apps.edit.content.slack_notifications.enabled') : trans('frontend.apps.edit.content.slack_notifications.disabled') }}
                </p>
            </div>
            <div class="flex w-full justify-end">
                <span class="inline-flex">
                    ...
                    >
                        {{ trans('frontend.apps.edit.content.save') }}
