            ...
            <div class="flex items-center justify-between flex-wrap sm:flex-no-wrap">
                <div>
                    <h3 class="text-lg leading-6 font-medium text-gray-900">
                        {{ trans('frontend.apps.edit.content.details') }}
                    </h3>
                </div>

                <x-flash-message event="app.updated" message="{{ trans('frontend.apps.edit.content.saved') }}" />
            </div>
        </div>

        <div class="px-4 py-6 sm:px-6">
            <x-inputs.text label="{{ trans('frontend.apps.edit.content.name') }}" name="name" maxWidth="max-w-lg" />
        </div>
                            ...
                            <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                                <div class="sm:flex sm:items-start">
                                    ...
                                    <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                        <h3 class="text-lg leading-6 font-medium text-gray-900">
                                            {{ trans('frontend.apps.edit.content.delete_this_app') }}
                                        </h3>
                                        <div class="mt-2">
                                            <p class="text-sm leading-5 text-gray-500">
                                                {{ trans('frontend.apps.edit.content.are_you_sure_you_want_to_delete') }} {{ $app->name }}{{ trans('frontend.apps.edit.content.this_action_is_permanent') }}
                                            </p>
                                        </div>
                                    </div>
                                </div>
