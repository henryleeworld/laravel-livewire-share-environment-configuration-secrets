    ...
    <div class="max-w-4xl mx-auto pb-12 px-4 sm:px-6">
        <form wire:submit.prevent="update" spellcheck="false" class="bg-white shadow overflow-hidden rounded-md">
                ...
                <div class="flex items-center justify-between flex-wrap sm:flex-no-wrap">
                    <div>
                        <h3 class="text-lg leading-6 font-medium text-gray-900">
                            {{ trans('frontend.account.content.details') }}
                        </h3>
                    </div>
            ...
            <div class="px-4 py-5 sm:p-6">
                <x-inputs.text label="{{ trans('frontend.account.content.first_name') }}" name="firstName" />

                <x-inputs.text label="{{ trans('frontend.account.content.last_name') }}" name="lastName" class="mt-6 sm:border-t sm:border-gray-200 sm:pt-5" />

                <x-inputs.text label="{{ trans('frontend.account.content.email_address') }}" name="email" type="email" maxWidth="max-w-lg"
            ...
            <div class="bg-gray-50 px-4 py-5 sm:p-6 flex justify-end">
                <span class="inline-flex">
                    ...
                    >
                        {{ trans('frontend.account.content.save') }}
