                        ...
                        <div class="flex items-center justify-between h-16 px-4 sm:px-0">
                                    ...
                                    <div @click.away="open = false" class="relative" x-data="{ open: false }" x-cloak>
                                        ...
                                        >
                                            <div class="py-1 bg-white rounded-md shadow-xs">
                                                <a href="{{ route('account') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">{{ trans('frontend.account.title') }} </a>
                                                <a href="{{ route('auth.logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                                                    {{ trans('frontend.auth.content.sign_out') }}
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="flex items-center -mr-2 md:hidden">
                                <button
                                    ...
                                    x-bind:aria-label="open ? '{{ trans('frontend.menu.content.close_main_menu') }}' : '{{ trans('frontend.menu.content.main_menu') }}'"
                                    x-bind:aria-expanded="open"
                                >
                                    <span x-show="!open">
