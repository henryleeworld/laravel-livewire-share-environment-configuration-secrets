            ...
            <div class="flex items-center justify-between flex-wrap sm:flex-no-wrap">
                <div>
                    <h3 class="text-lg leading-6 font-medium text-gray-900">
                        {{ trans('frontend.variables.create.title') }}
                    </h3>
                </div>
                    ...
                    >
                        <div class="flex-shrink-0">
                            <span class="inline-flex">
                                ...
                                >
                                    <span x-text="'{{ trans('frontend.variables.create.content.imported') }} ' + createdCount + ' {{ trans('frontend.variables.create.content.variables') }}'"></span>
        ...
        <form wire:submit.prevent="store" spellcheck="false">
            ...
            <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse sm:justify-between">
                <span class="flex w-full rounded-md shadow-sm sm:w-auto">
                    ...
                    >
                        {{ trans('frontend.variables.create.content.create') }}
                ...
                <span class="mt-3 flex w-full rounded-md shadow-sm sm:mt-0 sm:w-auto">
                    ...
                    >
                        {{ trans('frontend.variables.create.content.import') }}
                    </button>
                        ...
                        >
                            <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                                <div class="mt-3 text-center sm:mt-0 sm:text-left">
                                    <h3 class="text-lg leading-6 font-medium text-gray-900">
                                        {{ trans('frontend.variables.create.content.import_variables') }}
                                    </h3>
                            ...
                            <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                                ...
                                <span class="mt-3 flex w-full rounded-md shadow-sm sm:mt-0 sm:w-auto">
                                    ...
                                    >
                                        {{ trans('frontend.variables.create.content.cancel') }}
                                    </button>
                                </span>
                            </div>
                        </div>
