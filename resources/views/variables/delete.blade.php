<div class="bg-white rounded-lg overflow-hidden shadow-xl mx-auto">
        ...
        <div class="sm:flex sm:items-start">
            ...
            <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                <h3 class="text-lg leading-6 font-medium text-gray-900">
                    {{ trans('frontend.variables.delete.title') }}
                </h3>
                <div class="mt-2">
                    <p class="text-sm leading-5 text-gray-500">
                        {{ trans('frontend.variables.delete.content.are_you_sure_you_want_to_delete') }}
                    </p>
                </div>
            </div>
        </div>
    ...
    <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
        <span class="flex w-full rounded-md shadow-sm sm:ml-3 sm:w-auto">
            ...
            >
                {{ trans('frontend.variables.delete.content.confirm') }}
            </button>
        </span>
        <span class="mt-3 flex w-full rounded-md shadow-sm sm:mt-0 sm:w-auto">
            ...
            >
                {{ trans('frontend.variables.delete.content.cancel') }}
            </button>
        </span>
    </div>
</div>
